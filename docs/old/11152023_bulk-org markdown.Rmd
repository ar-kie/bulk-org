...
pca.df_upgraded <- cbind('COiMGxCondition'=as.factor(meta3$condition):as.factor(meta3$COiMg),'Condition'=meta3$condition,pca.df,t(batch.rem3_mod1[rownames(batch.rem3_mod1) %in% 
                                                                                                                                                          c('FOXJ1',
                                                                                                                                                            'CLDN5',
                                                                                                                                                            'IDO1',
                                                                                                                                                            'GBP5',
