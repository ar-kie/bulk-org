...
```{r heatmap.top50, echo=TRUE, fig.height = 4, fig.width = 5, fig.align = "center", message = FALSE, warning=FALSE, eval=TRUE}
...
kable(cbind('DEG'=rownames(top50.coimg),'lFC'=round(top50.coimg$log2FoldChange,2),'Cilia-associated'=rownames(top50.coimg) %in% organoid$CBC), format = "html") %>% kable_styling("striped") %>% scroll_box(width = "100%")
...
```{r ifny.heatmap.top50, echo=TRUE, fig.height = 3, fig.width = 5, fig.align = "center", message = FALSE, warning=FALSE, eval=TRUE}
...
kable(cbind('DEG'=rownames(top50.ifng),'lFC'=round(top50.ifng$log2FoldChange,2),'Cilia-associated'=rownames(top50.ifng) %in% organoid$CBC), format = "html") %>% kable_styling("striped") %>% scroll_box(width = "100%")
