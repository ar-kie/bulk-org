...
# PCA IFNy, LPS, ctr
```{r pca_all, echo=TRUE, fig.align = "center", message = FALSE, warning=FALSE, eval=TRUE}
...
```{r enrich.hm_COvCOiMg, echo=TRUE, fig.height = 6, fig.width = 3, fig.align = "center", message = FALSE, warning=FALSE, eval=TRUE}
...
## Gene set heatmap
```{r ifny.hm, echo=TRUE, fig.height = 3, fig.width = 6, fig.align = "center", message = FALSE, warning=FALSE, eval=TRUE}
