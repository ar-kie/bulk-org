...
load('~/Documents/R projects/bulk-org/12072023_bulk-org DEA.RData')
...
V1.83: corrected metadata and sample gene expression so that the analysis uses the right samples with proper annotation.
V1.84: corrected the gene set used for PC variance analysis across groups.
...
#sign reversal! beware of sign reversals!
...
#add variance analysis of cell-type markers
...
### IFNy
```{r line_overlap, echo=TRUE, fig.align = "center", message = FALSE, warning=FALSE, eval=TRUE}
...
### LinexCondition
```{r DEA_LinexCondition, echo=TRUE, fig.height = 6, fig.width = 8, fig.align = "center", message = FALSE, warning=FALSE, eval=TRUE}
...
### COiMg
```{r line_overlap_coimg, echo=TRUE, fig.align = "center", message = FALSE, warning=FALSE, eval=TRUE}
'IFNy_overlap_wtc11Xmsn9:'
...
### LinexCOiMG
```{r DEA_LinexCOiMG, echo=TRUE, fig.height = 6, fig.width = 8, fig.align = "center", message = FALSE, warning=FALSE, eval=TRUE}
#LinexCOiMG
for (i in  c('FOXJ1',
             'CLDN5',
             'IDO1',
...
PCAplot(pca_cor3_mod1, "interaction", Shape = "Line", PoV.df=PoV_cor3_mod1, pc.1 = 1, pc.2 = 2, 
        colors = colorRampPalette(rev(RColorBrewer::brewer.pal(9,"Spectral")))(6)) 
...
#### COiMGxCondition
```{r genes.int, echo=TRUE, fig.height = 6, fig.width = 6, fig.align = "center", message = FALSE, warning=FALSE, eval=TRUE}
for (i in  c('FOXJ1',
             'CLDN5',
             'IDO1',
             'GBP5',
...
# Full LinexConditionxCOiMG boxplots

```{r LinexConditionxCOiMG, eval=TRUE, echo=TRUE, fig.align="center", fig.height=6, fig.width=8, message=FALSE, warning=FALSE}
for (i in  c('FOXJ1',
             'CLDN5',
             'IDO1',
             'GBP5',
