...
```{r heatmap.top50, echo=TRUE, fig.height = 7, fig.width = 5, fig.align = "center", message = FALSE, warning=FALSE, eval=TRUE}
...
```{r ifny.heatmap.top50, echo=TRUE, fig.height = 7, fig.width = 5, fig.align = "center", message = FALSE, warning=FALSE, eval=TRUE}
